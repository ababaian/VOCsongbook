...
\beginverse*
\nolyrics{Intro: \[Em] \[Em] \[Em] \[Em] \[F] \[F] \[F] \[F] (x6)}
\endverse 	
\beginverse*
...
\beginverse*
(Rock out)
\[Em] \[F] \[G] (x4) Play the same as the verse
\endverse 	
\textnote{Repeat Chorus}
\beginverse*
\textnote{Bridge:}
\[Em] \[Em] \[Em] \[Em] \[F] \[F] \[F] \[F] (x4)
\endverse 	
\beginverse*
...
\endverse 	
\beginverse*
\[Em]I never felt so much alike alike alike alike (fade out)
\endverse 	
\endsong
