...
\echo{Note: Strum chords once} Maybe we could put a \[Em]little tiny fridge in there some\[C]where
\endchorus
...
Of course we would, we'd just eat \[G] more \[D] \[C] \[G] \[D] \[C]
\endchorus
...
\echo{Note: Strum chords once} If I \[D]had a million \[G]do\[Em]lla\[C]rs \[D]
I'd be \[G]rich
\endverse
\endsong
